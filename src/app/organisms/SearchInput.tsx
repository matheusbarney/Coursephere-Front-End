    ...
    return (
        ...
        <form className="max-w-2xl mx-auto">
            <div className="flex shadow-xs rounded-base -space-x-0.5 gap-2">
                ...
                <input type="search" id="search-dropdown" className="rounded-2xl px-3 py-2.5 bg-neutral-secondary-medium border border-default-medium text-heading text-xl focus:ring-brand focus:border-brand block w-2xl placeholder:text-body" placeholder="Search lessons" required />
                <Button type="submit" mainText="Search"
                    icon={<svg className="w-6 h-6 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 20"><path stroke="currentColor" strokeLinecap="round" strokeWidth="2" d="m21 21-3.5-3.5M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z"/></svg>
                    }
                showText={true}/>
            </div>
        </form>
